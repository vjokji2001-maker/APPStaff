...
class MedicineService {
  static String get _listUrl => ApiEndpoints.medicineList;
  static String get _detailsUrl => ApiEndpoints.medicineDetails;
  ...
  static Future<List<String>> fetchMedicines({required String query}) async {
    ...
    final listResponse = await ApiDebugHttp.post(
      Uri.parse(_listUrl),
      headers: headers,
      body: listBody,
    );
  ...
  static Future<Map<String, dynamic>?> fetchMedicineDetails(String medicineName) async {
    ...
    try {
      ...
      final detailsResponse = await ApiDebugHttp.post(

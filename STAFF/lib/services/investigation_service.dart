...
class InvestigationService {
  static String get _packageUrl => ApiEndpoints.packageList;
  static String get _investigationTypeBaseUrl =>
      '${ApiHost.smartcareMainBaseUrl}/investigation/master/testtypelist';
  static String get _templateUrl => ApiEndpoints.investigationTemplate;
  static String get _practitionerUrl => ApiEndpoints.practitionerList;
  static String get _saveTestRequestUrl => ApiEndpoints.saveInvestigation;
  static String get _parameterListUrl => ApiEndpoints.parameterList;
  static String get _getChargeUrl => ApiEndpoints.getCharge;
  static String get _jobTitleListUrl => ApiEndpoints.jobTitleList;
  static String get _patientInfoUrl => '${ApiHost.smartcareMainBaseUrl}/patient/information';
  static String get _patientIpdDetailsUrl => '${ApiHost.billingBaseUrl}/statement/patientinfoandlastipddetails';
  ...
  static Future<List<String>> fetchInvestigations({
    ...
    final response = await ApiDebugHttp.get(Uri.parse(_packageUrl), headers: headers);
  ...
  static Future<List<String>> fetchInvestigationTemplates() async {
    ...
    final response = await ApiDebugHttp.get(Uri.parse(_templateUrl), headers: headers);

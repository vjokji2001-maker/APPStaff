...
class ApprovalService {
  static String get _bankNameUrl => '${ApiHost.masterBaseUrl}/bankName/get';
  static String get _refundRequestListUrl => '${ApiHost.billingBaseUrl}/refund/get-request-list';
  static String get _locationUrl => '${ApiHost.billingBaseUrl}/charges/location/list';
  static String get _invoiceTypeListUrl => '${ApiHost.billingBaseUrl}/invoice/typelist';
  static String get _refundListUrl => '${ApiHost.billingBaseUrl}/refund/get-request-list';
  static String get _approveAllRefundUrl => '${ApiHost.billingBaseUrl}/refund/approveAll';
  static String get _discountDashboardUrl => '${ApiHost.billingBaseUrl}/discount/dashboard';
  static String get _discountApproveUrl => '${ApiHost.billingBaseUrl}/discount/approve';
  static String get _refundCancelUrl => '${ApiHost.billingBaseUrl}/refund/request/cancle';
  static String get _refundApproveUrl => '${ApiHost.billingBaseUrl}/refund/approve';
  static String get _invoiceFetchByPractitionerUrl => '${ApiHost.billingBaseUrl}/invoice/fetch/practitonerid';
  static String get _refundPayAgainstInvoiceUrl => '${ApiHost.billingBaseUrl}/refund/pay/against/invoice';
  ...
  Future<Map<String, dynamic>> approveRefund({
    ...
    try {
      ...
      final response = await ApiDebugHttp.put(
  ...
  Future<Map<String, dynamic>> testConnection() async {
    try {
      ...
      try {
        ...
        final testResponse = await ApiDebugHttp.post(
          Uri.parse(_refundCancelUrl),
          headers: headers,

...
/// Status badge types
enum HRStatus { approved, pending, rejected, active, inactive, paid, due, overdue }

extension HRStatusX on HRStatus {
  String get label {
    switch (this) {
      case HRStatus.approved:  return 'Approved';
      case HRStatus.pending:   return 'Pending';
      case HRStatus.rejected:  return 'Rejected';
      case HRStatus.active:    return 'Active';
      case HRStatus.inactive:  return 'Inactive';
      case HRStatus.paid:      return 'Paid';
      case HRStatus.due:       return 'Due';
      case HRStatus.overdue:   return 'Overdue';
    }
  }

  Color get color {
    switch (this) {
      case HRStatus.approved:  return HRTheme.success;
      case HRStatus.pending:   return HRTheme.pending;
      case HRStatus.rejected:  return HRTheme.error;
      case HRStatus.active:    return HRTheme.teal;
      case HRStatus.inactive:  return HRTheme.textSecondary;
      case HRStatus.paid:      return HRTheme.success;
      case HRStatus.due:       return HRTheme.warning;
      case HRStatus.overdue:   return HRTheme.error;
    }
  }

  Color get bgColor {
    switch (this) {
      case HRStatus.approved:  return HRTheme.successLight;
      case HRStatus.pending:   return HRTheme.pendingLight;
      case HRStatus.rejected:  return HRTheme.errorLight;
      case HRStatus.active:    return const Color(0xFFE0F2F1);
      case HRStatus.inactive:  return const Color(0xFFECEFF1);
      case HRStatus.paid:      return HRTheme.successLight;
      case HRStatus.due:       return HRTheme.warningLight;
      case HRStatus.overdue:   return HRTheme.errorLight;
    }
  }

  IconData get icon {
    switch (this) {
      case HRStatus.approved:  return Icons.check_circle_rounded;
      case HRStatus.pending:   return Icons.schedule_rounded;
      case HRStatus.rejected:  return Icons.cancel_rounded;
      case HRStatus.active:    return Icons.radio_button_checked;
      case HRStatus.inactive:  return Icons.radio_button_unchecked;
      case HRStatus.paid:      return Icons.verified_rounded;
      case HRStatus.due:       return Icons.warning_amber_rounded;
      case HRStatus.overdue:   return Icons.error_rounded;
    }
  }
}

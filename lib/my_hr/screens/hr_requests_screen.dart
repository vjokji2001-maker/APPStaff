...
class _HRRequestsScreenState extends State<HRRequestsScreen> {
  ...
  Widget _buildList(bool isDark) {
    ...
    if (requests.isEmpty) {
      return const HREmptyState(
        ...
        title: 'No Requests',
        subtitle: 'No requests found. Tap + to submit a new request.',
      );
    }
  ...
  Widget _buildRequestCard(HRRequest r, bool isDark) {
    final statusColor = r.status == 'Approved'
        ...
        ? HRTheme.pending
        : HRTheme.error;
    final statusBg = r.status == 'Approved'
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: HRTheme.requests.withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(HRTheme.radiusSM),
                ),
                child: Icon(
                  _requestIcon(r.type),
                  size: 18,
                  color: HRTheme.requests,
                ),
              ),

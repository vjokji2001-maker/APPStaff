...
class _HRAssetsScreenState extends State<HRAssetsScreen> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          HRGradientHeader(
            title: 'My Assets',
            subtitle: 'Assigned equipment & items',
          ),
          Expanded(
            child: ListView(
                            ...
                            .map(
                              (e) => Container(
                                ...
                                decoration: BoxDecoration(
                                  color: HRTheme.assets.withValues(alpha: 0.1),
  ...
  Widget _buildAssetCard(HRAsset a, bool isDark) {
    final condColor = a.condition == 'Excellent'
        ? HRTheme.success
        : a.condition == 'Good'
        ? HRTheme.teal
        : HRTheme.warning;
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 48,
              decoration: BoxDecoration(
                color: HRTheme.assets.withValues(alpha: 0.12),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${a.assetCode} · Assigned: ${a.assignedDate}',
                    style: GoogleFonts.poppins(
                      fontSize: 11,
            ...
            Column(
              ...
              children: [
                ...
                HRStatusBadge(
                  label: a.condition,
                  color: condColor,
                  bgColor: condColor.withValues(alpha: 0.1),
                ),
              ],
            ),
          ],
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: HRTheme.moduleGradient(HRTheme.assets),
                    borderRadius: BorderRadius.circular(HRTheme.radiusMD),
                  ),
                  child: Icon(
                    _assetIcon(a.type),
            ...
            HRInfoRow(
              label: 'Return Date',
              value: a.returnDate ?? 'Not returned',
            ...
            HRTimelineItem(
              ...
              subtitle: 'Issued from HR stores',
              time: a.assignedDate,
              color: HRTheme.success,
            ...
            HRTimelineItem(
              ...
              subtitle: '${a.condition} condition verified',
              time: a.assignedDate,
              color: HRTheme.info,

...
class _HRProfileScreenState extends State<HRProfileScreen> {
  ...
  Widget _buildTab() {
    switch (_tabIndex) {
      ...
      case 1:
        return _buildOfficialTab();
      case 2:
        return _buildFamilyTab();
      case 3:
        return _buildEduExpTab();
      case 4:
        ...
        return HRCard(
          ...
          child: Row(
            children: [
              CircleAvatar(
                radius: 24,
                backgroundColor: HRTheme.profile.withValues(alpha: 0.12),
                child: Text(
                  i < relations.length ? relations[i] : '👤',
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ...edu.asMap().entries.map(
            (e) => HRTimelineItem(
              title: e.value.degree,
              subtitle:
                  '${e.value.institution} · ${e.value.field}\n${e.value.grade}',
              time: e.value.year,
              color: HRTheme.profile,
                  ...
                  children: allergies
                      .map(
                        (a) => Container(
                          ...
                          decoration: BoxDecoration(
                            color: HRTheme.errorLight,
                            borderRadius: BorderRadius.circular(
                              HRTheme.radiusFull,
                            ),
                            border: Border.all(
                              color: HRTheme.error.withValues(alpha: 0.3),
                            ),
                          ),
                          child: Text(
                            a,

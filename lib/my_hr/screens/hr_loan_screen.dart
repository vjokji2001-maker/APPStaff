...
class _HRLoanScreenState extends State<HRLoanScreen> {
  ...
  Widget _buildTab() {
    if (HRMockData.loans.isEmpty) {
      return const HREmptyState(
        ...
        subtitle: 'You have no loans at the moment',
      );
    }
    final loan = HRMockData.loans.first;
    switch (_tabIndex) {
      case 0:
        return _buildDetailsTab(loan);
      case 1:
        return _buildEMIScheduleTab(loan);
      case 2:
        return _buildPaymentHistoryTab(loan);
      default:
        return _buildDetailsTab(loan);
    }
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Principal Amount · ${loan.interestRate}% p.a.',
                  style: GoogleFonts.poppins(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      '₹${_fmt(loan.totalRepaid)} / ₹${_fmt(loan.principalAmount)}',
                      style: GoogleFonts.poppins(
                        color: Colors.white,
                        fontSize: 11,
                        fontWeight: FontWeight.w600,
            ...
            child: Column(
              ...
              children: [
                ...
                HRInfoRow(
                  ...
                  iconColor: HRTheme.error,
                ),
                HRInfoRow(
                  label: 'Total Repaid',
                  value: '₹${_fmt(loan.totalRepaid)}',
                  icon: Icons.check_circle_outline_rounded,
                  iconColor: HRTheme.success,
                  isLast: true,
                ),
              ],
            ),
  ...
  Widget _loanPill(String label, String val) => Expanded(
    child: Container(
  ...
  Widget _buildEMIScheduleTab(LoanDetail loan) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) {
        ...
        final statusColor = emi.status == 'Paid'
            ? HRTheme.success
            : emi.status == 'Overdue'
            ? HRTheme.error
            : HRTheme.pending;
        final statusBg = emi.status == 'Paid'
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: isNext
                ? Border.all(color: HRTheme.pending.withValues(alpha: 0.4))
                : null,
          ...
          child: ListTile(
            ...
            title: Text(
              '₹${_fmt(emi.amount)} · Due: ${emi.dueDate}',
              style: GoogleFonts.poppins(
                fontSize: 12,
                fontWeight: FontWeight.w600,
            ...
            subtitle: emi.paidDate != null
                ? Text(
                    'Paid on ${emi.paidDate}',
                    style: GoogleFonts.poppins(
                      fontSize: 11,
              ...
              children: [
                if (isNext)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: HRTheme.pending.withValues(alpha: 0.1),
                      borderRadius: BorderRadius.circular(HRTheme.radiusFull),
                    ),
                    child: Text(
                      'Next',
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'EMI #${emi.installmentNo} – ₹${_fmt(emi.amount)}',
                      style: GoogleFonts.poppins(
                        fontSize: 13,
                        fontWeight: FontWeight.w700,
                      ),
                    ...
                    Text(
                      'Due: ${emi.dueDate}${emi.paidDate != null ? ' · Paid: ${emi.paidDate}' : ''}',
                      style: GoogleFonts.poppins(
                        fontSize: 11,

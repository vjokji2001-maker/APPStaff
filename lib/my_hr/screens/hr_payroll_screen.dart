...
class _HRPayrollScreenState extends State<HRPayrollScreen> {
          ...
          Expanded(
            child: _isLoading
                ...
                ? const HREmptyState(
                    ...
                    subtitle: 'Salary slips will appear here',
                  )
                : _buildTab(),
          ),
        ],
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${slip.month} ${slip.year} · ${slip.payPeriod}',
                  style: GoogleFonts.poppins(
                ...
                Row(
                  children: [
                    _salaryPill(
                      'Gross',
                      '₹${_fmt(slip.grossEarnings)}',
                      Colors.white.withValues(alpha: 0.2),
                    ),
                    const SizedBox(width: 10),
                    _salaryPill(
                      'Deductions',
                      '-₹${_fmt(slip.totalDeductions)}',
                ...
                Text(
                  'Credit Date: ${slip.creditDate} · ${slip.presentDays}/${slip.workingDays} days',
                  style: GoogleFonts.poppins(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: HRTheme.success.withValues(alpha: 0.3)),
            ),
            child: Row(
  ...
  Widget _buildSummaryTab() {
    ...
    if (slips.isEmpty)
      return const HREmptyState(
        ...
        title: 'No Data',
        subtitle: 'Salary summary will appear here',
      );
            ...
            child: Column(
              ...
              children: [
                ...
                _ytdRow(
                  ...
                  slips.fold(0.0, (s, e) => s + e.grossEarnings),
                ),
                _ytdRow(
                  'Total Deductions',
                  slips.fold(0.0, (s, e) => s + e.totalDeductions),
                ),
                _ytdRow(
                  'Total Net Salary',
                  slips.fold(0.0, (s, e) => s + e.netSalary),
                  isHighlight: true,
                ),
                const Divider(height: 20),
                _ytdRow(
                  'PF Contribution',
                  slips.fold(0.0, (s, e) => s + e.pfDeduction),
                ),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          height: 44,
                          decoration: BoxDecoration(
                            color: HRTheme.payroll.withValues(alpha: 0.1),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Gross ₹${_fmt(s.grossEarnings)} · -₹${_fmt(s.totalDeductions)}',
                                style: GoogleFonts.poppins(
                                  fontSize: 11,
                                  color: HRTheme.textSecondary,
                                ),
  ...
  Widget _buildBonusTab() {
    final slips = _slips;
    final bonusSlips = slips
        .where(
          (s) => s.bonus > 0 || s.nightAllowance > 0 || s.doctorIncentive > 0,
        )
        .toList();
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
        ...
        children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '₹${_fmt(slips.fold(0.0, (s, e) => s + e.bonus + e.nightAllowance + e.doctorIncentive))}',
                      style: GoogleFonts.poppins(
                        color: Colors.white,
                        fontSize: 24,
                        fontWeight: FontWeight.w800,
          ...
          if (bonusSlips.isEmpty)
            const HREmptyState(
              ...
              subtitle: 'Bonus and incentive payments will appear here',
            )
          else
            ...bonusSlips.map(
              (s) => HRCard(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Net: ₹${_fmt(s.netSalary)} · ${s.creditDate}',
                      style: GoogleFonts.poppins(
                        fontSize: 11,
                        color: HRTheme.textSecondary,
                      ),

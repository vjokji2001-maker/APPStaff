...
class _HRDocumentsScreenState extends State<HRDocumentsScreen> {
              ...
              children: [
                ...
                if (expiring.isNotEmpty && _selectedCategory == 'All')
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: HRTheme.warning.withValues(alpha: 0.4),
                      ),
                    ),
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            '${expiring.length} document(s) expiring soon. Please renew.',
                            style: GoogleFonts.poppins(
                              fontSize: 12,
                              color: HRTheme.warning,
                              fontWeight: FontWeight.w600,
                ...
                if (_filteredDocs.isEmpty)
                  const HREmptyState(
                    ...
                    subtitle: 'Upload documents or change your filter',
                  )
                else
  ...
  Widget _buildDocCard(HRDocument d, bool isDark) {
    final statusColor = d.status == 'Verified'
        ? HRTheme.success
        : d.status == 'Pending'
        ? HRTheme.pending
        : HRTheme.error;
    final statusBg = d.status == 'Verified'
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(HRTheme.radiusMD),
        border: d.isExpiringSoon
            ? Border.all(color: HRTheme.warning.withValues(alpha: 0.4))
            : null,
            ...
            Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: HRTheme.documents.withValues(alpha: 0.1),
                    borderRadius: BorderRadius.circular(HRTheme.radiusSM),
                  ),
                  child: Icon(
                    _docIcon(d.category),
                    size: 20,
                    color: HRTheme.documents,
                  ),
                ),
  ...
  Widget _docMeta(IconData icon, String label, String value) {
    return Column(
      ...
      children: [
        Text(
          label,
          style: GoogleFonts.poppins(fontSize: 9, color: HRTheme.textHint),
        ),
        Row(
          children: [
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: GoogleFonts.poppins(color: HRTheme.textHint),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: HRTheme.documents.withValues(alpha: 0.05),
                      borderRadius: BorderRadius.circular(HRTheme.radiusMD),
                      border: Border.all(
                        color: HRTheme.documents.withValues(alpha: 0.3),

...
class _HRShiftScreenState extends State<HRShiftScreen> {
  ...
  String _calculateScheduledHours() {
    int activeDays = _weekSchedule
        .where(
          (s) =>
              s.shiftName.isNotEmpty &&
              s.shiftName.toLowerCase() != 'off' &&
  ...
  Widget build(BuildContext context) {
    ...
    final isOff =
        selectedSchedule.shiftName.toLowerCase() == 'off' ||
  ...
  Widget _buildRosterTab(
    bool isDark,
    ShiftSchedule selectedSchedule,
    bool isOff,
  ) {
    return _isLoading
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final itemOff =
                            item.shiftName.toLowerCase() == 'off' ||
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final itemColor = itemOff
                          ? Colors.grey
                          : _shiftColor(item.shiftName);
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isSelected
                                ? HRTheme.shift.withValues(alpha: 0.06)
                                : (isDark
                                      ? const Color(0xFF1E293B)
                                      : Colors.white),
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(
                              color: isSelected
                                  ? HRTheme.shift.withValues(alpha: 0.5)
                                  : (isDark
                                        ? Colors.white12
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isSelected
                                        ? HRTheme.shift.withValues(alpha: 0.12)
